---
title: 2022-9-0 릴리스 개요
description: Adobe Experience Manager [!DNL Assets Essentials], [!DNL Sites], [!DNL Screens], [!DNL Forms] 및 [!DNL Cloud Foundation]용 2022-9-0 릴리스의 최신 기능과 혁신에 대해 알아보십시오.
...
# AEM as a Cloud Service 2022.9.0 릴리스 업데이트
...
* 템플릿 편집기에서 데이터 모델 지원
* 양식 서식 파일에서 DoR 템플릿 지원

Sites

* 스크립트 또는 API를 사용하여 컨텐츠 조각 모델 만들기

**프로덕션**

Assets Essentials

* 대규모 사용 기반에 대한 자산 액세스 관리

Asset Link

* 이제 Asset Link는 Asset Essentials 또는 Enterprise 자산을 Creative Cloud 팀 또는 Enterprise와 연결합니다
